#pragma checksum "C:\Users\Admin\Source\Repos\chandan8345\apicore\Mafia\Mafia\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1d36c894c1715b8e21fca00f606d87c19256d2bb"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1d36c894c1715b8e21fca00f606d87c19256d2bb", @"/Views/Home/Index.cshtml")]
...
<div class=""container-fluid"">
    <div class=""container"">
        <div class=""card"">
            ...
            <div class=""card-body"">
                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1d36c894c1715b8e21fca00f606d87c19256d2bb4764", async() => {
                ...
                WriteLiteral(@">
                        ...
                        <div class=""form-group col-md-3"">
                            ...
                            <select id=""designation"" class=""form-control"">
                                ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1d36c894c1715b8e21fca00f606d87c19256d2bb6588", async() => {
        ...
        $(function () {
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        ...
                                        $.each(data, function (index) {
                                            table");
            WriteLiteral(@" += '<tr><td>' + data[index][""name""] + '</td><td>' + data[index][""email""] + '</td><td>' + data[index][""age""] + '</td><td>' + data[index][""designation""] + '</td><td><button type=""button"" class=""btn btn-success""><i class=""bi bi-0-circle""></i></button></td></tr>';
                                        });
                                        $('#example tbody').append(table);
                                        $('#example').DataTable({
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('#example').DataTable().destroy();
                    $.each(data, function (index) {
                        $('#example tbody').append('<tr><td>' + data[index][""name""] + '</td><td>' + data[index][""email""] + '</td><td>' + data[index][""age""] + '</td><td>' + data[index][""designation""] + '</td><td> <a href="""" class=""btn btn-primary ");
            WriteLiteral(@"btn-sm"" type=""button"">Edit</a>  <button type=""button"" onclick=""deleteEmployee(' + data[index][""id""] +')"" class=""btn btn-danger btn-sm"">Delete</button></td></tr>');
                    });
                    $('#example').DataTable({
