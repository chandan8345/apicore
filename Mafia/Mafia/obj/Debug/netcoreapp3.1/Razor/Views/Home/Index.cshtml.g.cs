#pragma checksum "C:\Users\Admin\Source\Repos\chandan8345\apicore\Mafia\Mafia\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3c1b4d7bcebbc845e2946c0d6efc335b2a91e451"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3c1b4d7bcebbc845e2946c0d6efc335b2a91e451", @"/Views/Home/Index.cshtml")]
...
<div class=""container-fluid"">
    <div class=""container"">
        <div class=""card"">
            ...
            <div class=""card-body"">
                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3c1b4d7bcebbc845e2946c0d6efc335b2a91e4514764", async() => {
                ...
                WriteLiteral(@">
                        ...
                        <div class=""form-group col-md-3"">
                            ...
                            <select id=""designation"" class=""form-control"">
                                ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3c1b4d7bcebbc845e2946c0d6efc335b2a91e4516588", async() => {
...
<script type=""text/javascript"">
    jQuery(document).ready(function ($) {
        $(function () {
            ...
            $('#employe");
            WriteLiteral(@"e-form').on('submit', function (e) {
                e.preventDefault();
                var postData = {
                    ""name"": $(""#name"").val(),
                    ""email"": $(""#email"").val(),
                ...
                swal({
                    ...
                    if (yes) {
                        $.ajax({
                            type: ""POST"",
     ");
            WriteLiteral(@"                       url: '/api/test/employeeInsert',
            ...
            WriteLiteral(@"'<tr><td>' + data[index][""name""] + '</td><td>' + data[index][""email""] + '</td><td>' + data[index][""age""] + '</td><td>' + data[index][""designation""] + '</td></tr>');
                                        });
                                        $('#example').DataTable({
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (index) {
                        console.log(data[index][""name""]);
                        $('#example tbody').append('<tr><td>' + data[index][""name""] + '</td><td>' + data[index][""email""] + '</td><td>' + data[index][""age""] + '</td><td>' + data[index][""designation""] +'</td></tr>');
                    });
                    $('#example').DataTable({

                    });
                    // remove previously load");
            WriteLiteral(@"ed options
